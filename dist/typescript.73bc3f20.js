...
var estado = true; //numerico

var numero = 4; //String

var cadena = 'Hola mundo'; //Arrays
//Arrays de solo un dato

var personas = [];
personas = ['Miguel', 'Valeria']; //Arrays multi typos de datos

var personasYEdad = [];
personasYEdad.push('Angel');
personasYEdad.push(1);
personasYEdad.push(true); //Enum | enumeradores
...
var Objeto = {}; //Funciones

function add(a, b) {
  return a + b;
}

var sum = add(4, 5); //Arrow function en TypeScript

var primeraFn = function (a) {
  return function (b) {
    return b + a;
  };
};

var primeraFase = primeraFn(4);
var segundaFase = primeraFase(6);
var resul = segundaFase;
console.log(resul); //Pasar parametros opcionales o valores por omisión/defecto
//opcional

var nombreCompleto = function (primerNombre, apellido) {
  return primerNombre + " " + apellido;
};

var angel = nombreCompleto('Angel'); //omisión/defecto

var nombreCompleto1 = function (primerNombre, apellido) {
  if (apellido === void 0) {
    apellido = 'Loor';
  }
...
var angel1 = nombreCompleto1('Angel');
var rect = {
  ancho: 4,
  alto: 6,
  color: Color.rojo
...
rect.toString = function () {
  return this.color ? "Un rectangulo color " + this.color : "Un rectangulo sin color";
};

console.log(rect.toString()); //Clase en TypeScript

var Persona =
/** @class */
function () {
  function Persona(nombre, edad, colorCamisa) {
    this.nombre = nombre;
    this.edad = edad;
    this.colorCamisa = colorCamisa;
  }

  Persona.prototype.quienSoy = function () {
...
var miguel = new Persona('Angel', 24, Color.verde);
var quienEsMiguel = miguel.quienSoy();
console.log(quienEsMiguel); //Patrones de diseño
//singleton
...
console.log('A es igual a B?', a == b); //Patron Observer
